...
/**
 * Implémentation d'un acteur pour la question 5 du TP. Chaque acteur possède
 * une liste de voisins à qui il transmet les messages qu'il reçoit
 * 
...
public class MyActor extends UntypedActor {
	...
	public void onReceive(Object message) throws Exception {
		if (message instanceof IdMessage) {
			...
			// Si on n'a pas déjà reçu le message, on le transmet aux voisins
			// (sauf l'envoyeur)
