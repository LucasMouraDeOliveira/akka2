...
/**
 * Implémentation d'un actorSystem pour la question 4 du TP
 * 
...
public class MySystemServer {
	 ...
	 *            le nom du système
	 * @param port
	 *            le port sur lequel le système est démarré
	 * @param actorNames
	 *            une liste de noms d'acteurs à initialiser
	 */
	 ...
	 *            le port du serveur
	 * @param resource
	 *            le nom de la ressource à atteindre sur le serveur distant
	 * 
