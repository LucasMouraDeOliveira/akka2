...
/**
 * Message possédant un identifiant sous la forme d'une chaine de caractères. Le
 * message doit être interprêté par un acteur seulement s'il n'est pas référencé
 * dans la "base de données" de l'acteur
 * 
